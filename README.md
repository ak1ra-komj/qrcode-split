...
python qrcode-split.py <path_to_input_file> -c <chunk_size_in_bytes> -C

# For example:
python qrcode-split.py input/input-1.mp4 -c 1900 -C

# To generate the QR code files:
python qrcode-split.py <path_to_input_file> -c <chunk_size_in_bytes>

# For example:
python qrcode-split.py input/input-1.mp4 -c 1900
```
